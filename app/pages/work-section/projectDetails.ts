...
export const devProjects = [
  {
    ...
    technologies: ["NextJS", "CSS", "Framer Motion"],
    github: "https://github.com/rizwannur/tempest",
    demo: "https://www.tempest.rizwannur.xyz/",
...
export const designProjects = [
  {
    id: 1,
    name: "Tempest Landing Page",
    description:
      "A modern and responsive page for a startup ",
    technologies: ["Discord", "UI Design", "Prototyping"],
    github: "",
    demo: "",
