...
const ContactSection = ({ className = "" }: ContactSectionProps) => {
  return (
    <motion.section
      className={`relative z-10 flex h-[95vh] w-full items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center py-16 md:h-[80vh] md:py-20 lg:h-[90vh] lg:pt-0 lg:pb-28 3xl:h-[75vh] ${className}`}
      id="contact"
      initial="initial"
      animate="animate"
    >
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        ...
        >
          ...
          <Image
            src={heartIcon}
            alt="Heart Icon"
            className="heartbeat absolute -bottom-5 left-64 w-[120px] sm:-bottom-14 sm:left-[40%] md:-bottom-18 md:left-[40%] md:w-[150px] lg:-bottom-16 lg:left-[42%] lg:w-[230px]"
          />
        </div>
        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className="flex w-[350px] max-w-[90%] flex-col items-end text-right text-sm font-semibold uppercase text-[#e4ded7] sm:w-[350px] md:w-[310px] md:items-start md:text-left md:text-base lg:w-[420px]">
            <AnimatedBody
            ...
            <div className="mt-5 flex w-[298px] items-center gap-1 md:w-[335px] md:gap-2.5">
              <Link
                href={`mailto:${contactData.email}?subject=Lets%20work%20together!&amp;body=Hello%2C%20I%20think%20we%20need%20you%20to%20work%20on%2Fcollaborate%20this%20particular%20product...%20Reach%20out%20as%20soon%20as%20you%20can.`}
                target="_blank"
          ...
          <div className="flex gap-10 text-base font-bold text-[#e4ded7] sm:gap-14 sm:text-2xl md:gap-10 md:text-base lg:gap-20 lg:text-[28px]">
